...
var toolDefs={
  ...
  /* v5.40: history replay for drafts. loadHistItem calls
     getOrCreateToolTab(h.tool_name), which reads toolDefs[toolName].title —
     with no 'draft' entry that threw before rendering, so clicking a draft
     in History showed nothing. Drafts are generated from the Draft tab,
     never run from this tab, hence the descriptive body text. */
  draft:{title:'✍️ Draft',body:function(){return '<p class="tool-desc">Draft generated by the drafting engine. To edit, redraft or export it, load it from the Draft tab’s Previous drafts.</p>';}}
};
